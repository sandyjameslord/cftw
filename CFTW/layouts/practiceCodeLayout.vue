...
export default {
    ...
    methods: {
        ...
        displayDrewCode() {
            ...
            let drewCodeForDisplayHTML = sessionStorage.getItem("practicehtmlCodeForDisplay");
            let drewCodeForDisplayCSS = sessionStorage.getItem("practicecssCodeForDisplay");
        ...
        executeDrewJavaScript() {
            let drewCodeForDisplayJavaScript = sessionStorage.getItem("practicejavaScriptCodeForDisplay");
