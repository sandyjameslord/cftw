<template>
    <main>
        <div id="learningZone" class="learningZone">
            <div id="learningZoneLeft" class="learningZoneSide">
                <div class="titleAndInfoBox">
                    <div class="learningZoneTitle">Final Coding Area   </div>
                ...
                <!--  -->
                <div id="leftMainContainerOutside">
                    <div id="leftLeftSide"></div>
            
                    <div id="leftTop" class="leftSidePart">
                        <div id="leftHTML" class="sectionHolder">
                            <textarea id="leftHTMLCode" class="localCode local drewsmall" onpaste="alert(`Please do not use Copy and Paste here.\nWriting the code on your own will strengthen your skills!`);return false; "></textarea>
                        </div>
                    </div>
                    <div id="leftMiddle" class="leftSidePart">
                        <div id="leftCSS" class="sectionHolder">
                            <textarea id="leftCSSCode" class="localCode local drewsmall" onpaste="alert(`Please do not use Copy and Paste here.\nWriting the code on your own will strengthen your skills!`);return false; "></textarea>
                        </div>
                    </div>
                    <div id="leftBottom" class="leftSidePart">
                        <div id="leftJS" class="sectionHolder">
                            <textarea id="leftJavaScriptCode" class="localCode local drewsmall" onpaste="alert(`Please do not use Copy and Paste here.\nWriting the code on your own will strengthen your skills!`);return false; "></textarea>
                        </div>
                    </div>
            


                    <div id="leftSubbottom" class="leftSidePart">
                        <div id="leftOutput" class="sectionHolder">
                            <div id="htmlCode" class="hiddenDiv"></div>
                            <div id="cssCode" class="hiddenDiv"></div>
                            <div id="javaScriptCode" class="hiddenDiv"></div>
                            <iframe loading="lazy" id="leftDrewDisplay" src="" class="localDisplay"></iframe>
                        </div>
                    </div>

                            

                    <div id="leftVSlider1" class="leftVSlider"></div> 
                    <div id="leftVSlider2" class="leftVSlider"></div>
                    <div id="leftVSlider3" class="leftVSlider"></div>
            ...
            <div id="learningZoneRight" class="learningZoneSide">
                <div class="titleAndInfoBox">
                    <div class="learningZoneTitle">Output to Achieve   </div>
        ...
        <div id="controlBox">
            <div ontouchstart="" @click="openPage(`finalized`)">
                <div class="button controlBoxButton">
                    <nuxt-link to="">Finalize Level:<br>I have understood &#10003; &#128522;	</nuxt-link>
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            leftInfoTitleText: "Final Coding Area",
            ...
            rightInfoTitleText: "Output to Achieve",
            ...
            leftUpperVerticalSliderOriginalPosition: 0,
            leftLowerVerticalSliderOriginalPosition: 0,
            leftLowestVerticalSliderOriginalPosition: 0,
            leftUpperVerticalSliderNewPosition: 0,
            leftLowerVerticalSliderNewPosition: 0,
            leftLowestVerticalSliderNewPosition: 0,
            leftUpperVerticalSliderSetInInitialPositionOnHover: false,
            leftLowerVerticalSliderSetInInitialPositionOnHover: false,
            leftLowestVerticalSliderSetInInitialPositionOnHover: false,
    ...
    methods: {
        ...
        openPage(page) {
            ...
            // let textareaRandom = document.getElementById("leftHTMLCode")
            // textareaRandom.focus();

            // textareaRandom.dispatchEvent(new KeyboardEvent("keyup", {
            //     key: "e",
            // }))
            ...
            try {
                    ...
                    let response = this.$axios.$post("/api/drewSaveLessonStatuses", data);
        ...
        initiateLeftSide() {
            ...
            let htmlCodeDiv = document.getElementById("leftHTMLCode")
            let cssCodeDiv = document.getElementById("leftCSSCode")
            let javaScriptCodeDiv = document.getElementById("leftJavaScriptCode")

            let leftFinalProductDisplay = document.getElementById("leftDrewDisplay")



            htmlCodeDiv.addEventListener("keyup", () => {
                // console.log("html entered")
                let htmlValue = htmlCodeDiv.value
                let cssValue = cssCodeDiv.value
                let jsValue = javaScriptCodeDiv.value
                // console.log("HTML Value: " + htmlValue + "\nCSS Value: " + cssValue + "\nJS Value: " + jsValue + "\n")
                sessionStorage.setItem(`dadCodeForDisplayHTML`, htmlValue)
                sessionStorage.setItem(`dadCodeForDisplayCSS`, cssValue)
                sessionStorage.setItem(`dadCodeForDisplayJavaScript`, jsValue)

                leftFinalProductDisplay["src"] = ""

                // console.log(`htmlCodeDiv.prop("selectionStart")`, htmlCodeDiv.selectionStart)
                
                setTimeout(()=> {
                    leftFinalProductDisplay["src"] = "dadCode"    
            ...
            cssCodeDiv.addEventListener("keyup", () => {
                console.log("css entered")
                let htmlValue = htmlCodeDiv.value
                let cssValue = cssCodeDiv.value
                let jsValue = javaScriptCodeDiv.value
                console.log("HTML Value: " + htmlValue + "\nCSS Value: " + cssValue + "\nJS Value: " + jsValue + "\n")
            ...
            javaScriptCodeDiv.addEventListener("keyup", () => {
            ...
            // sessionStorage.setItem(`leftHTMLCodeForDisplay`, htmlValue)
            // sessionStorage.setItem(`leftCSSCodeForDisplay`, cssValue)
            // sessionStorage.setItem(`leftJavaScriptCodeForDisplay`, jsValue)



            // finalProductDisplay["src"] = ""
            // setTimeout(()=> {
            //     finalProductDisplay["src"] = "dadCode"    
            // }, 100)
            return false
        ...
        setUpSliders() {
            // left
            let leftVSlider1 = document.getElementById("leftVSlider1")
            let leftVSlider2 = document.getElementById("leftVSlider2")
            let leftVSlider3 = document.getElementById("leftVSlider3")

            leftVSlider1.addEventListener("mouseenter", (e) => {
                if (this.leftUpperVerticalSliderSetInInitialPositionOnHover == false) {
                    e = e || window.event;
                    e.preventDefault();
                    this.leftDragVSlider1()
                    this.leftUpperVerticalSliderSetInInitialPositionOnHover = true
                }
                else {
                    return
                }
            })
            leftVSlider2.addEventListener("mouseenter", (e) => {
                if (this.leftLowerVerticalSliderSetInInitialPositionOnHover == false) {
                    e = e || window.event;
                    e.preventDefault();
                    this.leftDragVSlider2()
                    this.leftLowerVerticalSliderSetInInitialPositionOnHover = true
                }
                else {
                    return
                }
            })
            leftVSlider3.addEventListener("mouseenter", (e) => {
                if (this.leftLowestVerticalSliderSetInInitialPositionOnHover == false) {
                    e = e || window.event;
                    e.preventDefault();
                    this.leftDragVSlider3()
                    this.leftLowestVerticalSliderSetInInitialPositionOnHover = true
                }
                else {
                    return
                }
            })
            leftVSlider1.addEventListener("mousedown", (e) => {
                this.leftDragVSlider1()
            })
            leftVSlider2.addEventListener("mousedown", (e) => {
                this.leftDragVSlider2()
            })
            leftVSlider3.addEventListener("mousedown", (e) => {
                this.leftDragVSlider3()
            })
...
// let middle = document.getElementById("middle")
        ...
        leftDragVSlider1() {
            ...
            let slider1 = document.getElementById("leftVSlider1")
            let slider2 = document.getElementById("leftVSlider2")
            ...
            function dragMouseDown(e) {
                ...
                this.leftUpperVerticalSliderNewPositionLevel2Left = e.clientY;
                document.onmouseup = closeDragElement;
                document.onmousemove = elementDrag;
            }
            ...
            function elementDrag(e) {
                ...
                let top = document.getElementById("leftTop")
                let middle = document.getElementById("leftMiddle")
                let bottom = document.getElementById("leftBottom")
                let subbottom = document.getElementById("leftSubbottom")
                // let topHeight = e.clientY
                let topHeight = e.clientY - (70 + 54)
                let topHeightPx = topHeight + "px"

                this.leftUpperVerticalSliderOriginalPositionLevel2Left = this.leftUpperVerticalSliderNewPositionLevel2Left - e.clientY;
                this.leftUpperVerticalSliderNewPositionLevel2Left = e.clientY;

                slider1.style.top = (slider1.offsetTop - this.leftUpperVerticalSliderOriginalPositionLevel2Left) + "px";
...
// let middle = document.getElementById("middle")
        ...
        leftDragVSlider2() {
            ...
            let slider1 = document.getElementById("leftVSlider1")
            let slider2 = document.getElementById("leftVSlider2")
            let slider3 = document.getElementById("leftVSlider3")
            ...
            function dragMouseDown(e) {
                ...
                this.leftLowerVerticalSliderNewPositionLevel2Left = e.clientY;
                document.onmouseup = closeDragElement;
                document.onmousemove = elementDrag;
            }
            ...
            function elementDrag(e) {
                ...
                let mainContainerOutside = document.getElementById("leftMainContainerOutside")
                ...
                this.leftLowerVerticalSliderOriginalPositionLevel2Left = this.leftLowerVerticalSliderNewPositionLevel2Left - e.clientY;
                this.leftLowerVerticalSliderNewPositionLevel2Left = e.clientY;
                let slider2Top = slider2.offsetTop - this.leftLowerVerticalSliderOriginalPositionLevel2Left
                slider2.style.top = (slider2Top) + "px";
        ...
        leftDragVSlider3() {
            ...
            function dragMouseDown(e) {
                ...
                this.leftLowestVerticalSliderNewPositionLevel2Left = e.clientY;
                document.onmouseup = closeDragElement;
                document.onmousemove = elementDrag;
            }
            ...
            function elementDrag(e) {
                ...
                this.leftLowestVerticalSliderOriginalPositionLevel2Left = this.leftLowestVerticalSliderNewPositionLevel2Left - e.clientY;
                this.leftLowestVerticalSliderNewPositionLevel2Left = e.clientY;
                let slider3Top = slider3.offsetTop - this.leftLowestVerticalSliderOriginalPositionLevel2Left
                slider3.style.top = (slider3Top) + "px";
    ...
    updated() {
        sessionStorage.setItem("currentTitle", "Mastery")
    },
    beforeMount() {
        sessionStorage.setItem("currentTitle", "Mastery")
    },
