<template>
    <main>
        <div id="learningZone" class="learningZone">
            <div id="learningZoneLeft" class="learningZoneSide">
                <div class="titleAndInfoBox">
                    <div class="learningZoneTitle">Practice Area   </div>
        ...
        <div id="controlBox">
            <div ontouchstart="" @click="openPage(`paircode`)">
                <div class="button controlBoxButton">
                    <nuxt-link to="">Next level:<br>Pair Code</nuxt-link>
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            leftInfoTitleText: "Practice Area",
...
// let middle = document.getElementById("middle")
    ...
    updated() {
        sessionStorage.setItem("currentTitle", "Interaction")
    },
    beforeMount() {
        sessionStorage.setItem("currentTitle", "Interaction")
    },
