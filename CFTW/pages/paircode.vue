<template>
    <main>
        <div id="learningZone" class="learningZone">
            <div id="learningZoneLeft" class="learningZoneSide">
                <div class="titleAndInfoBox">
                    <div class="learningZoneTitle">Coding Area   </div>
            ...
            <div id="learningZoneRight" class="learningZoneSide">
                <div class="titleAndInfoBox">
                    <div class="learningZoneTitle">Code Along With Drew   </div>
        ...
        <div id="controlBox">
            <div ontouchstart="" @click="openPage(`mastery`)">
                <div class="button controlBoxButton">
                    <nuxt-link to="">Next level:<br>Mastery</nuxt-link>
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            rightInfoTitleText: "Code Along With Drew",
...
// let middle = document.getElementById("middle")
    ...
    updated() {
        sessionStorage.setItem("currentTitle", "PairCode")
    },
    beforeMount() {
        sessionStorage.setItem("currentTitle", "PairCode")
    },
